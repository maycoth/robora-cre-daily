    ...
    <section className="relative w-full bg-white font-sans overflow-hidden">
      <div className="container mx-auto px-6 md:px-10 py-16 md:py-24 lg:py-32">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20 md:mb-28 lg:mb-32">
          <p className="text-[#6B7280] font-semibold tracking-[0.2em] text-xs md:text-sm uppercase mb-6 md:mb-8">
            Others
          </p>
          <h2 className="text-4xl md:text-5xl lg:text-[56px] font-bold text-[#2E7FD6] leading-[1.15] md:leading-[1.15] tracking-tight">
            Do more of what you enjoy.<br />
            <span className="text-[#2E7FD6]">Leave cash management to us.</span>
          </h2>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-stretch">
          ...
          <div className="w-full lg:w-1/2 lg:pr-16 xl:pr-24 pb-12 lg:pb-0 z-10 flex flex-col justify-start pt-8 lg:pt-16">
            <h3 className="text-3xl md:text-[36px] font-bold text-[#2E7FD6] leading-tight mb-10 md:mb-14">
          ...
          <div className="w-full lg:w-1/2 relative min-h-[300px] lg:min-h-auto">
            ...
            */}
            <div className="absolute top-0 left-0 w-[200vw] h-[120%] -translate-y-0 lg:-translate-y-12 bg-[#003D7A] rounded-tl-[60px] md:rounded-tl-[80px]" />
    ...
    <div className="group flex items-center space-x-6 cursor-pointer select-none">
      <div className="flex-shrink-0 w-4 h-5 md:w-5 md:h-6 relative">
        <svg 
          ...
          className="w-full h-full text-[#003D7A] transition-transform duration-300 group-hover:translate-x-1"
        >
          <path 
      ...
      <span className="text-sm md:text-base font-bold tracking-[0.15em] text-[#003D7A] uppercase transition-opacity duration-300 group-hover:opacity-80">
        {text}
      </span>
    </div>
  );
